...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'channels',
    # 'drf_yasg',  # Temporarily commented out
...
# CSRF Configuration for React development
...
CELERY_BEAT_SCHEDULE = {
    'send-due-reminders': {
        'task': 'medicationManagment.tasks.send_due_reminders',
        'schedule': 60.0,  # Every minute
    },
    'generate-daily-doses': {
        'task': 'medicationManagment.tasks.generate_medication_doses',
